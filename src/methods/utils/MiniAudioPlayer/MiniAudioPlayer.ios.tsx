...
/**
 * iOS-specific implementation of MiniAudioPlayer for rendering remote audio streams
 * with optional waveform visualization overlay.
 *
 * @platform ios
 *
 * ### Key Features
 * - Uses RTCView for native iOS audio rendering
 ...
 *   remoteProducerId="producer-xyz"
 *   parameters={meetingParameters}
 *   MiniAudioComponent={CustomIOSWaveform}
 * />
 * ```
 */
